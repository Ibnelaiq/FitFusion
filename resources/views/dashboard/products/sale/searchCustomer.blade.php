<x-app-layout>
    ...
    <div class="w-full mt-8">
        ...
        <div class="mt-8 flex justify-center">
            <div class="w-2/3">
                <h2 class="text-3xl font-semibold mb-4">Search Customer Results:</h2>
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-4 flex flex-wrap justify-between items-center">
                        ...
                        <form id="update-sale-form" action="{{ route('products.updateSale', ['sale' => $sale, 'customer' => $customer]) }}" method="POST">
                            @csrf
                            @method('PUT')

                            <!-- Your form fields go here -->

                            <button type="submit" class="bg-gray-800 hover:bg-gray-700 text-white py-2 px-4 rounded">Update Sale</button>
                        </form>
                        <div class="w-full">
