<x-app-layout>
    ...
    <div class="container">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title mb-0"><span class="text-light"> Workout /</span> Edit </h5>
    ...
    <script>
        ...
        jQuery(() => {
            ...
            var muscles = $("input[name='muscles']").val().split(",");

            $("#backSVG path").click(function(){
                let id = $(this).attr("id");
                UpdateMuscles(id,muscles,"muscles");
            })
        ...
        function updateMuscleUI(inputField){
            ...
            // $(".workout-muscles path").each(function(index,item){
            //     let id = item.getAttribute("id");

            //     if(muscles.indexOf(id) !== -1){
            //         // In array
            //         $(item).addClass("selected_muscle");
            //     }
            //     else{
            //         // not in array
            //         $(item).removeClass("selected_muscle");
